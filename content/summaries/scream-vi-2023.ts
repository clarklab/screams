...
const spoilerFree = `One year after the Woodsboro killings, Sam and Tara Carpenter have relocated to New York City along with fellow survivors Chad and Mindy Meeks-Martin. Sam is struggling with PTSD and visions of her father Billy Loomis, while online conspiracy theories accuse her of being the real Ghostface killer.
...
As the body count rises across the city -- from the subway to apartment buildings to a bodega -- the group enlists help from returning Scream 4 survivor Kirby Reed, now an FBI agent, and Sam's neighbor Danny. Gale Weathers is attacked in her penthouse, surviving only because Sam and Tara arrive in time.
...
const fullPlot = `The film opens with a twist on the franchise formula: film professor Laura Crane is lured into an alley and murdered by Ghostface, who immediately unmasks as Jason Carvey, a Blackmore University student. Jason calls his roommate Greg to celebrate, but upon arriving home finds Greg dead. The real Ghostface calls Jason and murders him, establishing a more brutal and unpredictable killer.
